    ...
    <section className="mb-20 px-6 py-12">
      <div className="mx-auto grid max-w-4xl gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        {whyMeData.map((item, index) => (
          <div
            key={index}
            className="flex transform items-center space-x-4 rounded-lg bg-gray-200 p-6 shadow-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl dark:bg-gray-800 dark:shadow-xl dark:hover:bg-indigo-600 dark:hover:shadow-2xl"
          >
